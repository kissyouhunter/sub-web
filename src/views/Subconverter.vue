        ...
        remoteConfig: [
          {
            ...
            options: [
              ...
              {
                label: "ACL4SSR_Online_MultiCountry 国家分组 (与Github同步)",
                value:
              ...
              {
                label: "ACL4SSR_Online_Mini_MultiCountry.ini 精简版 国家分组 (与Github同步)",
                value:
              ...
              {
                label: "ACL4SSR_Online_Full_MultiMode 全分组 重度用户使用 多模式 (与Github同步)",
                value:
              ...
              },
              {
                label: "自用",
                value:
                  "https://raw.githubusercontent.com/kissyouhunter/Tools/main/Subconverter/ACL4SSR_KISS.ini"
              },
              {
                label: "Mobile",
                value:
                  "https://raw.githubusercontent.com/kissyouhunter/Tools/main/Subconverter/ACL4SSR_MOBILE.ini"
              },
              {
                label: "Mobile GPT",
                value:
                  "https://raw.githubusercontent.com/kissyouhunter/Tools/main/Subconverter/ACL4SSR_MOBILE_GPT.ini"
              },
              {
                label: "Surfboard",
                value:
                  "https://raw.githubusercontent.com/kissyouhunter/Tools/main/surfboard/surfboard.ini"
              }
            ]
          },
        ]
